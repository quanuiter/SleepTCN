...
Nghiên cứu sử dụng Sleep-EDF Expanded do PhysioNet phân phối và dữ liệu Sleep Heart Health Study qua National Sleep Research Resource. Tác giả xác nhận đã xin được quyền truy cập SHHS qua NSRR cho phân tích này; mọi acknowledgement bắt buộc của nguồn dữ liệu sẽ được giữ trong bản nộp.
