...
Phân tích lớp sử dụng dự đoán ngoài fold gộp của seed 42. Bảng~\ref{tab:sleepedf-class-errors} báo cáo precision, recall, F1 của E3 và E6 cùng chênh lệch F1. Đây là thống kê mô tả trên artifact test, không phải một họ kiểm định mới.
...
Trong ma trận nhầm lẫn E3, các cặp sai số lớn nhất là N3$\rightarrow$N2 (16.674), N2$\rightarrow$REM (11.605), N2$\rightarrow$N1 (5.947), W$\rightarrow$N1 (4.481) và N1$\rightarrow$REM (1.717). Đây là các chẩn đoán mô tả trên cohort SHHS1 đã khóa; chúng không được dùng để suy ra cơ chế nhân quả của tiền xử lý.
