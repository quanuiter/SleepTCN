...
Furthermore, as detailed in the context ablation study (Figure \ref{fig:context_ablation}), removing the explicit Current/Previous/Next (C/P/N) epoch context does not significantly degrade boundary performance (Holm $p = 1.000$). This strongly supports the premise that sequence models with extended receptive fields, such as the evaluated TCN (253 epochs), successfully capture broad temporal dynamics natively, rendering the localized C/P/N clustering redundant.
\begin{figure}[htbp]
    \centering
