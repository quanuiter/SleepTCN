...
\end{subfigure}
\caption{Supporting representation and context analyses. Lines in (a) join the two
representation scores from the same test fold. Error bars in (b) show marginal subject-cluster
bootstrap 95\% intervals; Holm correction applies to the three Wilcoxon tests only.}
