...
Các dự đoán E6 và chỉ số tính lại đã được xác minh ở cấp artifact. Mã SHA-256 của protocol ghi trong run manifest (\seqsplit{165d7cdf614ff071da7bd5ca94eb4e52dd8bee1ce5eafb712c2c8a0d0550fe93}) khớp chính xác với snapshot lịch sử \texttt{configs/shhs\_zero\_shot\_v1.json} được giữ trong kho. Tệp \texttt{configs/shhs\_v1\_protocol.json} hiện tại có mã (\seqsplit{9541e2334cdae98b5d36b95a2656993cdaaffb35a3160dad70af11d14b653fe9}) vì đây là hồ sơ mở rộng sau chạy, không phải snapshot đã dùng để tạo dự đoán; không được thay thế hash lịch sử bằng hash này. Do đó provenance protocol đã có thể truy nguyên, còn phân tích E6 vẫn được diễn giải là tái phân tích mô tả từ dự đoán đã khóa, không phải lượt tái sinh mới.
...
\subsection{Tài trợ và đóng góp tác giả}

Phân tích này không nhận khoản tài trợ riêng nào từ cơ quan công, thương mại hoặc phi lợi nhuận. Nghiên
cứu Sleep Heart Health Study nền được hỗ trợ bởi các thỏa thuận hợp tác của National Heart, Lung, and
Blood Institute. Ngô Nhật Quân là tác giả chính và tác giả liên hệ, phụ trách ý tưởng, phương pháp,
phần mềm, phân tích, quản lý dữ liệu, trực quan hóa và bản thảo. Phạm Thái Sơn phụ trách giám sát,
đóng góp phương pháp và hiệu đính. Cả hai tác giả đã duyệt bản cuối.
