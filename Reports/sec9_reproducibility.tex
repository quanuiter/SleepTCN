...
N3$\rightarrow$N2 tái diễn ở E0/E3 và có mức tăng Macro-F1 phản thực lớn nhất trong các kênh đơn được xét trên E3 & E3 gây ra lỗi này hoặc sửa kênh này chắc chắn đạt \mf\ 0,7444 \\
...
Tác giả xác nhận đã xin được quyền truy cập SHHS qua NSRR và, theo xác nhận của tác giả, phân tích thứ cấp dữ liệu đã khử định danh không cần xét duyệt đạo đức tại đơn vị áp dụng; báo cáo không nêu mã phê duyệt. Nghiên cứu nhận khoảng 6.000.000 VND hỗ trợ sinh viên từ Trường Đại học Công nghệ Thông tin, Đại học Quốc gia Thành phố Hồ Chí Minh; hai tác giả tuyên bố không có xung đột lợi ích. Repository mã nguồn công khai là \url{https://github.com/quanuiter/SleepTCN}; đường truy cập dữ liệu gốc và phạm vi chia sẻ được nêu ở mục Tình trạng dữ liệu dẫn xuất phía trên.
