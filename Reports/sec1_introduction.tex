...
\begin{enumerate}
  ...
  \item Trong cùng họ ResNet-1D--TCN, pipeline xử lý tín hiệu nào giữ thứ hạng tốt hơn khi đi từ Sleep-EDF sang SHHS1 zero-shot?
...
\begin{itemize}
  ...
  \item bằng chứng rằng các thay thế kiến trúc riêng lẻ chưa tạo ưu thế dự báo ổn định, trong khi ResNet-1D--TCN đem lại đánh đổi vận hành đo được;
  \item một đánh giá zero-shot trên mẫu SHHS1 đã khóa, cho thấy toàn bộ pipeline E3 giữ lợi thế so với hai đối chứng đã định trước nhưng vẫn chịu khoảng hụt chuyển miền lớn;
