...
Chiến dịch ngoài miền sử dụng một mẫu SHHS Visit 1 đã được khóa trước khi xem kết quả mô hình. SHHS là nghiên cứu đoàn hệ đa trung tâm và dữ liệu được phân phối qua National Sleep Research Resource~\cite{quan1997shhs,zhang2018nsrr}. Mẫu kiểm tra gồm 180 đối tượng; việc suy luận được thực hiện trên EEG C4--A1 và không cập nhật trọng số bằng dữ liệu SHHS. Các mô hình được đánh giá bằng toàn bộ các fold tương ứng, sau đó tổ hợp xác suất theo đối tượng.
