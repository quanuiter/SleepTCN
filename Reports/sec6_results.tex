...
E3 giữ F1 cao nhất ở W và N2, trong khi N1 vẫn là lớp khó nhất. Chênh lệch F1 lớn nhất giữa E3 và E6 nằm ở N3 (+0,062782); các lớp còn lại tăng từ +0,002551 đến +0,015199. Ma trận nhầm lẫn của E3 và E6 được trình bày theo thứ tự hàng là nhãn thật và cột là nhãn dự đoán.
...
\subsubsection{Thời gian huấn luyện và hoàn thiện artifact}
...
\begin{table}[H]
\centering
\caption{Thời gian chạy huấn luyện và validation của chiến dịch seed 123}
...
Các cặp nhầm lẫn lớn nhất của E3 trên SHHS1 là N3$\rightarrow$N2 (16.674 epoch), N2$\rightarrow$REM (11.605), N2$\rightarrow$N1 (5.947), W$\rightarrow$N1 (4.481) và N1$\rightarrow$REM (1.717). So với E2, số N2 bị gán thành REM và số N3 bị gán thành N2 đều giảm, phù hợp với mức tăng F1 mô tả ở các lớp liên quan; đây vẫn là diễn giải mô tả trên mẫu đã khóa, không phải bằng chứng về cơ chế nhân quả.
