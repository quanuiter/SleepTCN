...
Cả hai khoảng tin cậy chính đều hoàn toàn dương và Wilcoxon vẫn có ý nghĩa sau Holm. Vì vậy E3 có Macro-F1 trung bình theo đối tượng cao hơn E0 và E6 trong mẫu SHHS1 và giao thức chuyển miền đã khóa. E0/E3 là suy luận inductive; E6 là chuẩn hóa không nhãn có tính transductive ở cấp bản ghi. Các chỉ số hỗ trợ cũng cùng chiều.
...
Để kiểm tra liệu suy giảm gần ranh giới có tái diễn qua mô hình và cohort hay không, phân tích hậu nghiệm dùng cùng định nghĩa trên dự đoán test seed 42 đã khóa của E0 và E3. Vùng lân cận là hợp của ba vị trí quanh mỗi thay đổi nhãn tham chiếu: epoch ngay trước, epoch đầu tiên của nhãn mới và epoch kế tiếp. Vùng ổn định cách mọi thay đổi nhãn ít nhất ba vị trí liên tiếp. Các vùng được tạo từ nhãn tham chiếu, không từ dự đoán; do đó đây là chẩn đoán đánh giá ngoại tuyến chứ không phải bộ phát hiện chuyển pha có thể triển khai.
...
Cả hai mô hình đều suy giảm rõ ở vùng lân cận trên cả hai cohort, trong khi E3 vẫn cao hơn E0 về \mf\ tại vùng này. Kiểm tra độ nhạy chỉ giữ các thay đổi nhãn có ít nhất ba epoch liên tiếp ở mỗi phía cho cùng hướng: \mf\ E0/E3 là 0,6253/0,6377 trên Sleep-EDF và 0,4591/0,4864 trên SHHS1. Tuy nhiên, recall N3 của E0/E3 ngay trong vùng ổn định SHHS1 vẫn chỉ là 0,4008/0,3900, thấp xa Sleep-EDF. Vì vậy, vùng thay đổi nhãn làm bài toán khó hơn nhưng không giải thích toàn bộ lỗi N3 ngoài miền; kết quả cũng không xác định nguyên nhân là sinh lý, thực hành chấm hay thiết bị.
...
Đây không phải hiệu năng mà một thuật toán thực tế chắc chắn đạt được. Phép tính được thực hiện trên dự đoán E3 và chỉ cho thấy N3$\rightarrow$N2 có đòn bẩy lớn nhất, tiếp theo là N2$\rightarrow$REM; nó không quy lỗi này cho E3. Tổng phần trăm có thể vượt 100\% vì Macro-F1 phi tuyến và hai cohort có phân bố lớp khác nhau. Việc N3$\rightarrow$N2 cũng chiếm 72,3\% số epoch N3 ở E0 củng cố lựa chọn mục tiêu thích nghi, nhưng không biến phân tích E3 thành một đối chiếu nhân quả giữa kiến trúc. Do đó, thí nghiệm tiếp theo hợp lý hơn một vòng thay kiến trúc hoặc chuẩn hóa chung là hiệu chỉnh/fine-tune có nhãn theo lớp, báo cáo riêng recall và false-positive N3 tại ranh giới N2--N3.

\subsection{Phân tích bổ sung thành phần E1/E2 trên SHHS1}

Sau chiến dịch chuyển miền chính, một giao thức riêng được khóa trước khi suy luận E1/E2. Các mô hình không được cập nhật trọng số bằng SHHS và được đánh giá trên cùng 180 đối tượng. E1--E0 cô lập thay BiLSTM bằng TCN; E2--E1 thay gói C/P/N 75 chiều của E1 bằng embedding ResNet-1D 128 chiều chỉ từ epoch hiện tại, nên không được diễn giải là hiệu ứng riêng của encoder.
