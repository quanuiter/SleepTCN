...
E3 có giá trị mô tả cao nhất trong chiến dịch chính seed 42, nhưng thứ hạng này không tự tạo bằng chứng thống kê. Bảng~\ref{tab:primary_stats} trình bày bốn so sánh chính đã định trước.
...
E1--E0 và E2--E1 có mức tăng mô tả nhỏ, nhưng CI chứa 0 và $p$ Holm lớn hơn 0,05. Vì vậy chưa đủ bằng chứng rằng TCN tốt hơn BiLSTM hoặc ResNet-1D tốt hơn 15CNN về \mf. E3--E2 có CI gộp vừa dương nhưng chỉ 37/78 người tăng, median chênh lệch theo người âm và Wilcoxon không có ý nghĩa; lợi ích không đồng đều theo đối tượng. Trong seed 42, E3--E6 là kết quả nhất quán nhất theo cả bootstrap và Wilcoxon-Holm.

\subsubsection{Phân tích độ nhạy sau giao thức với seed 123}

Chiến dịch seed 123 hoàn tất 60/60 lượt validation và 60/60 lượt test. Mỗi cấu hình vẫn phủ đúng 153 bản ghi, 78 đối tượng và 195.469 epoch hợp lệ; trình kiểm định sâu xác nhận đủ prediction, metrics, checkpoint và căn chỉnh bắt cặp cho cả 60 lượt. Bảng~\ref{tab:seed_sensitivity_models} và~\ref{tab:seed_sensitivity_contrasts} đối chiếu hai seed mà không gộp phép kiểm định.
