...
E1 dùng lại đúng encoder E0 và chỉ thay BiLSTM bằng TCN, nên E1--E0 cô lập thay đổi mô hình chuỗi. E1 cung cấp vector 75 chiều từ các nhánh C/P/N, còn E2 dùng embedding ResNet-1D 128 chiều chỉ từ epoch hiện tại. Vì vậy E2--E1 đồng thời thay encoder, bỏ ngữ cảnh P/N tường minh và đổi số chiều đặc trưng; đây là đối chiếu gói đặc trưng/ngữ cảnh, không phải phép cô lập riêng encoder.
...
\midrule
Có nên thay kiến trúc/gói đặc trưng? & Gate 5, Gate 6; E1--E0 và E2--E1 & Hiệu ứng TCN riêng; hiệu ứng gói E2; đánh đổi tốc độ--tài nguyên \\
...
Riêng E6 tính trung bình và độ lệch chuẩn trên toàn bộ tín hiệu của từng bản ghi SHHS đích sau lọc và cắt biên, không dùng nhãn. Do đó E6 là chuẩn hóa bản ghi đích không nhãn có tính transductive; E0/E1/E2/E3 không dùng thống kê của bản ghi đích và mới là các phép suy luận thuần inductive. Thuật ngữ ``zero-shot'' trong tên chiến dịch chỉ khẳng định không cập nhật trọng số hoặc dùng nhãn SHHS, không được dùng để che khuất khác biệt này.
