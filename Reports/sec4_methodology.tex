...
Benchmark được thực hiện trên cùng phần cứng cho tất cả cấu hình. Phép đo phản ánh suy luận forward và không bao gồm đọc dữ liệu, tiền xử lý, lưu trữ trung gian hoặc huấn luyện. Phân tích không gian đặc trưng so sánh các biểu diễn trên cùng epoch và cùng fold; Silhouette được dùng như chỉ số hỗ trợ, còn t-SNE chỉ dùng để minh họa.
