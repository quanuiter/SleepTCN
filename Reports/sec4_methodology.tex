...
Macro-F1 gộp trên dự đoán test ngoài fold là chỉ số mô tả chính. Khoảng tin cậy 95\% của chênh lệch được ước lượng bằng bootstrap bắt cặp theo cụm đối tượng; kiểm định Wilcoxon hai phía được thực hiện trên Macro-F1 từng đối tượng. Hiệu chỉnh Holm chỉ áp dụng cho bốn đối chiếu đã đăng ký trước: thay đổi mô hình chuỗi, thay đổi bộ trích đặc trưng, thay đổi chế độ xử lý chính và đối chiếu với z-score.
...
Benchmark được thực hiện trên cùng phần cứng cho tất cả cấu hình. Phép đo phản ánh suy luận forward và không bao gồm đọc dữ liệu, tiền xử lý, lưu trữ trung gian hoặc huấn luyện. Thời gian wall-clock của chiến dịch seed 123 được báo cáo riêng, bao gồm huấn luyện, validation và hoàn thiện artifact trên 10 fold; các lượt được chạy tuần tự và test chưa được mở. Phân tích không gian đặc trưng so sánh các biểu diễn trên cùng epoch và cùng fold; Silhouette được dùng như chỉ số hỗ trợ, còn t-SNE chỉ dùng để minh họa.
