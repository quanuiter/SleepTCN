...
Trong đối chiếu hậu nghiệm SHHS1 đã quan sát, chênh lệch E3--E2 là $+0,04750$ Macro-F1 trung bình theo người, lớn hơn chênh lệch của E1--E0 và E2--E1. Phần mở rộng seed 123 cũng cho thấy E4 chỉ lọc dải cao hơn đầu vào thô E2, và cao hơn E3 cùng seed. Các kết quả làm nổi bật vai trò của cấu hình tiền xử lý trong mẫu này; chúng không phải một phép kiểm định trực tiếp rằng trục tiền xử lý luôn quan trọng hơn kiến trúc hoặc có lợi tức đầu tư nghiên cứu cao hơn. Lọc dải, đổi thang và tương tác với huấn luyện chưa được tách bằng một thiết kế nhân tố xác nhận độc lập.
