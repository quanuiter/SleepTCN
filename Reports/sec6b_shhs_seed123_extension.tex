...
Một phân tích mở rộng được thực hiện trên cùng mẫu 180 đối tượng SHHS1 để đối chiếu trực tiếp chế độ lọc dải với các chế độ xử lý biên độ khác. Phân tích không cập nhật trọng số bằng dữ liệu SHHS và được xem là bằng chứng bổ sung sau các kết quả chính.
...
E4 cao hơn E2 0,0323 điểm Macro-F1 trung bình theo đối tượng, với khoảng tin cậy 95\% $[0,0236;0,0410]$, kiểm định Wilcoxon--Holm $p=7,40\times10^{-13}$ và thắng/hòa/thua 135/1/44. E4 cũng cao hơn E3 0,0098 điểm theo hướng E4, cho thấy thứ hạng giữa các chế độ xử lý biên độ có thể phụ thuộc vào miền dữ liệu và seed.
