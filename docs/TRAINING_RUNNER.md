...
```text
runs/{smoke|full}/E?/fold_XX/seed_N/
  run_manifest.json
  checkpoints/
...
python D:\SleepTCN\scripts\validate_run_artifacts.py `
  ...
  --run-root D:\SleepTCN\runs\smoke\E2\fold_00\seed_42 `
  --output D:\SleepTCN\runs\smoke\E2\fold_00\seed_42\validation_report.json
```
